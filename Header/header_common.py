...
def find_object(objects,object_id):
  ...
  while (i_object < num_objects) and (result == -1):
    ...
    #print(str(object[0]).lower()+" - "+object_id_lowercase)
    if (str(object[0]).lower() == object_id_lowercase):
      result = i_object
    i_object += 1
  return result
...
# Ensure SWYSDK configuration variable is defined
...
## <-- WSE header_common additions end