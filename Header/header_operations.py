...
################################################################################
  ...
  # cmpxchg8b, Caba'drin, SonKidd, MadVader, dunde, Ikaguia, MadocComadrin, Swyter and
  # Cjkjvfnby.
...
is_edit_mode_enabled                  =  255  # (is_edit_mode_enabled),
                                              # Checks if the scene editor (Ctrl+E) is active. Useful for making additions to the default UI.
...
store_last_sound_channel =  615  # (store_last_sound_channel, <destination>),
                                 # Fills the register with the last channel of the sound system used by the engine.
stop_sound_channel       =  616  # (stop_sound_channel, <sound_channel_no>),
                                 # Forces the audio system's channel specified to stop
...
overlay_set_additional_render_height              =  952  # (overlay_set_additional_render_height, <overlay_id>, <height_adder>),
                                                          # Manipulates the vertical offset of the rendered mesh
...
if swysdk['enable_wse']:
 ...
 #the above operation conflicts with the new one from WB 1.05X
  ...
  lhs_operations      += [try_for_agents, try_for_attached_parties, try_for_active_players, try_for_prop_instances, store_trigger_param, menu_create_new, overlay_get_val, str_length, str_index_of, str_last_index_of, str_get_char, str_to_num, str_compare, str_split, face_keys_get_hair, face_keys_get_beard, face_keys_get_face_texture, face_keys_get_hair_texture, face_keys_get_hair_color, face_keys_get_age, face_keys_get_morph_key, val_shr, store_shr, val_lshr, store_lshr, val_shl, store_shl, val_xor, store_xor, val_not, store_not, register_get, store_wse_version, store_current_trigger, store_num_return_values, store_return_value, mtrand, get_time, game_key_get_key, dict_create, dict_get_size, dict_get_int, agent_get_item_modifier, agent_get_item_slot_modifier, agent_get_animation_progress, agent_get_dna, agent_ai_get_look_target, agent_ai_get_move_target, agent_ai_get_behavior_target, agent_get_ground_scene_prop, agent_get_item_slot_ammo, agent_get_item_slot_hit_points, agent_get_wielded_item_slot_no, agent_get_scale, agent_get_item_slot_flags, multiplayer_get_cur_profile, multiplayer_get_num_profiles, multiplayer_cur_message_get_int, server_map_rotation_get_count, server_map_rotation_get_index, server_map_rotation_get_map, server_get_horse_friendly_fire, server_get_show_crosshair, get_server_option_at_connect, store_cur_mission_template_no, get_spectated_agent_no, get_water_level, cast_ray, troop_get_skill_points, troop_get_attribute_points, troop_get_proficiency_points, item_get_weight, item_get_value, item_get_difficulty, item_get_head_armor, item_get_body_armor, item_get_leg_armor, item_get_hit_points, item_get_weapon_length, item_get_speed_rating, item_get_missile_speed, item_get_max_ammo, item_get_accuracy, item_get_shield_width, item_get_shield_height, item_get_horse_scale, item_get_horse_speed, item_get_horse_maneuver, item_get_food_quality, item_get_abundance, item_get_thrust_damage, item_get_thrust_damage_type, item_get_swing_damage, item_get_swing_damage_type, item_get_horse_charge_damage, party_stack_get_experience, party_stack_get_num_upgradeable, position_get_vector_to_position, get_last_sound_channel, options_get_battle_size, options_get_verbose_casualties, options_get_cheat_mode, fst, edit_mode_get_num_selected_prop_instances, edit_mode_get_selected_prop_instance, edit_mode_get_highlighted_prop_instance]
  can_fail_operations += [is_vanilla_warband, presentation_activate, str_equals, str_contains, str_starts_with, str_ends_with, str_is_alpha, str_is_digit, str_is_whitespace, item_slot_gt, party_template_slot_gt, troop_slot_gt, faction_slot_gt, quest_slot_gt, scene_slot_gt, party_slot_gt, player_slot_gt, team_slot_gt, agent_slot_gt, scene_prop_slot_gt, order_flag_is_active, key_released, game_key_released, dict_is_empty, dict_has_key, camera_in_first_person, cast_ray, troop_has_flag, item_has_property, item_has_capability, item_has_modifier, item_has_faction, party_has_flag, feq, fgt, flt, fge, fle, edit_mode_in_edit_objects_mode]
